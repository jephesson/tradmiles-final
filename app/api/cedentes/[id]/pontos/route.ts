...
const PROGRAM_FIELD: Record<string, "pontosLatam" | "pontosSmiles" | "pontosLivelo" | "pontosEsfera"> = {
  LATAM: "pontosLatam",
  SMILES: "pontosSmiles",
  LIVELO: "pontosLivelo",
  ESFERA: "pontosEsfera",
...
export async function PATCH(
  ...
  try {
    ...
    return NextResponse.json({ ok: true, id: updated.id, program, points: (updated as any)[field] });
  } catch (e: any) {
